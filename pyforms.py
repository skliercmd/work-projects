...
connection = pyodbc.connect('Driver={SQL Server};Server=localhost;Database=datadictionary;UID=sa;PWD=yourStrong(!)Password')
...
for index, row in df3.iterrows():   
    cursor.execute("""insert into dbo.forminfo(
                            [form_type], 
                            [form_id],
                            [form_ver],
                            [web_label], 
